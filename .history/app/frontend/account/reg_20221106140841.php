...
if (isset($_SESSION['user_password'])){
    echo $_SESSION['user_password'];
                    ...
                    <button type="submit" class="w-full text-white btn bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
