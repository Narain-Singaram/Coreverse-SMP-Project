...
if (isset($_SESSION['user_password'])){
    echo $_SESSION['user_password'];
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="remember" aria-describedby="remember" type="checkbox" class="checkbox w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-indigo-300" required="">
                            </div>
                    ...
                    <button type="submit" class="w-full text-white btn border-none bg-indigo-600 hover:bg-indigo-700 focus:outline-none rounded-2xl text-sm px-5 py-2.5 text-center">Sign in</button>
