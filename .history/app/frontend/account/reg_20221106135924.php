            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                        ...
                        <input type="email" name="email" id="email"  class="input w-full" data-theme="light" placeholder="Joe McDonald" required="">
                    </div>
                    <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900">Email</label>
                        <input type="email" name="email" id="email" class="input w-full" data-theme="light" placeholder="name@company.com" required="">
                    </div>
                    <div>
